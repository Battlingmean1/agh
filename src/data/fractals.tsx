...
export const Fractals: FractalsType = {
	'trojkat-sierpinskiego': {
		...
		authorImage: 'https://github.com/Battlingmean1/agh/blob/main/public/images/fractalAuthors/Waclaw_Sierpinski.jpg',
		authorDescription:
	...
	'platek-kocha': {
		...
		definition: (
			<>
				...
				zastępowana &#34;wypukłym zębem&#34; w kształcie mniejszego równobocznego trójkąta. Proces powtarza się
				nieskończoną ilość razy, tworząc symetryczną, śnieżynkopodobną strukturę o nieskończonej długości obwodu i
				skończonym polu powierzchni.
			</>
		),
